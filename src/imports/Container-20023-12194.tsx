import svgPaths from "./svg-7jcyibfmrh";

function Heading() {
  return (
    <div className="h-[21px] relative shrink-0 w-[220px]" data-name="Heading 3">
    ...
    <div className="relative shrink-0 size-[14px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Icon">
          ...
          <path d="M4.66667 8.16667H4.6725" id="Vector_5" stroke="var(--stroke-0, #314158)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M7 8.16667H7.00583" id="Vector_6" stroke="var(--stroke-0, #314158)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M9.33333 8.16667H9.33917" id="Vector_7" stroke="var(--stroke-0, #314158)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M4.66667 10.5H4.6725" id="Vector_8" stroke="var(--stroke-0, #314158)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M7 10.5H7.00583" id="Vector_9" stroke="var(--stroke-0, #314158)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
          <path d="M9.33333 10.5H9.33917" id="Vector_10" stroke="var(--stroke-0, #314158)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.16667" />
        </g>
      </svg>
    </div>
  );
...
function Text() {
  return (
    <div className="flex-[1_0_0] h-[19.5px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] left-0 not-italic text-[#314158] text-[13px] top-0 whitespace-nowrap">Selecionar mês</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[33.5px] relative shrink-0 w-[117.453px]" data-name="Container">
...
function Container2() {
  return (
    <div className="h-[34.5px] relative shrink-0 w-[668px]" data-name="Container">
...
function Text1() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[132px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[19.5px] left-0 not-italic text-[#62748e] text-[13px] top-0 whitespace-nowrap">Dia</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[12.5px] relative shrink-0 w-[132px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[12.5px] min-h-px min-w-px not-italic relative text-[#90a1b9] text-[10px]">Seleção livre de datas</p>
      </div>
    </div>
  );
}
...
function Label() {
  return (
    <div className="h-[54px] relative rounded-[10px] shrink-0 w-[184px]" data-name="Label">
...
function Text4() {
  return (
    <div className="h-[12.5px] relative shrink-0 w-[132px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[12.5px] min-h-px min-w-px not-italic relative text-[#314158] text-[10px]">Meses completos</p>
      </div>
    </div>
  );
}
...
function Label1() {
  return (
    <div className="bg-[#f1f5f9] h-[54px] relative rounded-[10px] shrink-0 w-[184px]" data-name="Label">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[12px] items-center px-[12px] relative size-full">
        <Container9 />
        <Container11 />
      </div>
...
function Container5() {
  return (
    <div className="h-[265px] relative shrink-0 w-[205px]" data-name="Container">
