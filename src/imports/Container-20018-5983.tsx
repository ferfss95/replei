import svgPaths from "./svg-9nzeppg0el";
...
function Button() {
  return (
    <div className="bg-[#314158] flex-[1_0_0] h-[24.5px] min-h-px min-w-px relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[16.5px] left-[56.5px] not-italic text-[11px] text-center text-white top-[4px] whitespace-nowrap">Período Fechado</p>
      </div>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="h-[24.5px] relative rounded-[8px] shrink-0 w-[108.25px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[16.5px] left-[54.5px] not-italic text-[#62748e] text-[11px] text-center top-[4px] whitespace-nowrap">Dias da Semana</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[8px] relative">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16.5px] not-italic relative shrink-0 text-[#62748e] text-[11px] whitespace-nowrap">Seleção de data início e fim</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="flex-[102.5_0_0] h-[36.5px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[2px] items-start relative size-full">
        <Text6 />
        <Text7 />
      </div>
  ...
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Icon">
          <path d="M6 1.5V4.5" id="Vector" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M12 1.5V4.5" id="Vector_2" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p13693a10} id="Vector_3" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M2.25 7.5H15.75" id="Vector_4" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="flex-[158.5_0_0] h-[52.5px] min-h-px min-w-px relative rounded-bl-[10px] rounded-tl-[10px]" data-name="DateRangePicker">
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[10px] items-center px-[14px] relative size-full">
          <Container16 />
          <Icon />
        </div>
      </div>
...
function SlotClone() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[10px] w-[320px]" data-name="SlotClone">
