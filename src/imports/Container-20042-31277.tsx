import svgPaths from "./svg-4ho32psv7u";

function Heading() {
  return (
    <div className="content-stretch flex h-[16px] items-start relative shrink-0 w-full" data-name="Heading 3">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[16px] min-h-px min-w-px not-italic relative text-[#314158] text-[12px] tracking-[0.6px] uppercase">Alterar tipo de análise</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="bg-[#f4f7fa] relative rounded-[14px] shrink-0 w-full" data-name="Container">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center p-[15px] relative w-full">
          <Icon />
          <Container3 />
          <Container4 />
        </div>
    ...
    <div className="relative shrink-0 size-[15px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="Icon" opacity="0.8">
          <path d={svgPaths.p2c360000} id="Vector" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
          <path d="M10 4.375H13.75V8.125" id="Vector_2" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function Text2() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[187px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[18px] left-0 not-italic text-[#62748e] text-[12px] top-0 tracking-[0.3px] uppercase whitespace-nowrap">Evolutiva</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="h-[12.5px] relative shrink-0 w-[187px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[12.5px] min-h-px min-w-px not-italic relative text-[#90a1b9] text-[10px]">quebrar colunas por período</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="flex-[187_0_0] h-[32.5px] min-h-px min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[2px] items-start relative size-full">
        <Text2 />
        <Text3 />
      </div>
...
function Icon3() {
  return (
    <div className="relative shrink-0 size-[15px]" data-name="Icon">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="Icon" opacity="0.8">
          <path d="M5 1.875L2.5 4.375L5 6.875" id="Vector" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
          <path d="M2.5 4.375H12.5" id="Vector_2" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
          <path d={svgPaths.p11e6a580} id="Vector_3" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
          <path d="M12.5 10.625H2.5" id="Vector_4" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
        </g>
      </svg>
    </div>
  );
...
function Text4() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[187px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[18px] left-0 not-italic text-[#62748e] text-[12px] top-0 tracking-[0.3px] uppercase whitespace-nowrap">Comparativa</p>
      </div>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="h-[12.5px] relative shrink-0 w-[187px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[12.5px] min-h-px min-w-px not-italic relative text-[#90a1b9] text-[10px]">analisar 2 grupos de período</p>
      </div>
    </div>
  );
}
