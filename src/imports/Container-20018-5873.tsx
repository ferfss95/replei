...
function Text4() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[107px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[19.5px] left-0 not-italic text-[#314158] text-[13px] top-0 whitespace-nowrap">Ano</p>
      </div>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-[#314158] content-stretch flex items-center justify-center px-[15px] py-[4px] relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] shrink-0" data-name="Button">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16.5px] not-italic relative shrink-0 text-[11px] text-center text-white whitespace-nowrap">Selecionar ano</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[97px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#45556c] text-[12px] whitespace-nowrap">Ano</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="flex-[270_0_0] min-h-px min-w-px relative w-[893px]" data-name="Container">
